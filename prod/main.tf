...
module "vpc" {
  ...
  vpc_name = "three-tier-VPC-prod"
  public_subnet_cidr_block = "10.0.0.0/24"
  public_subnet_name = "Three-tier-Public-Subnet-prod"
  public_sub_availability_zone = "us-east-1a"
  private_subnet_cidr_block = "10.0.1.0/24"
  private_subnet_name = "Three-tier-Private-subnet-prod"
  private_sub_availability_zone = "us-east-1b"
  public_subnet_cidr_block_2 = "10.0.2.0/24"
  public_subnet_name_2 = "Three-tier-Public-Subnet-prod-2"
  public_sub_availability_zone_2 = "us-east-1b"
  private_subnet_cidr_block_2 = "10.0.3.0/24"
  private_subnet_name_2 = "Three-tier-Private-subnet-prod-2"
  private_sub_availability_zone_2 = "us-east-1a"
}

module "rds" {
  source = "../Modules/RDS"
  identifier = "three-tier-db-prod"
  allocated_storage = 10
  db_name              = "ThreeTierDbProd"
  db_engine               = "mysql"
  db_engine_version       = "8.0"
  instance_type       = "db.t3.micro"
  rds_username             = "soham"
  subnet_group_name    = "three-tier-subnet-group-prod"
  ...
  identifier_replica = "three-tier-db-prod-replica"
